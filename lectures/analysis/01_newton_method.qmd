...
- ✏️ **Edit** the code
- ▶️ **Run** it with the "Run Code" button
- 🔄 **Reset** to the original with "Start Over"
...
ax.set_xlabel('x')
ax.set_ylabel('y')
ax.set_title("Newton's Method: Finding √2")
ax.legend()
